...
PRODUCT_COPY_FILES += \
    ...
    frameworks/base/data/etc/android.hardware.sensor.compass.xml:system/etc/permissions/android.hardware.sensor.accelerometer.xml \
...
PRODUCT_COPY_FILES += \
    ...
    device/dell/gallo/system/app/FileManage.apk:system/app/FileManage.apk \
